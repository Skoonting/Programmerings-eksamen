...
while($linje1 = fgets ($fil1)){
    if($linje1 != ""){
        ...
        $kKode1 = trim($del1[0]);
        if($kKode1 == $bildeNr){
            array_push($eksisterendeBilderArray, "a"); 
            /*
                array_push, legger verdier i en array.
                Ved bruk av dette i en en while-loop, legger den til en verdi i arrayen hvis den ser at man har skrevet inn en kode som allerede er i bilde.txt. 
                Hvis det er noen verdi i arrayen, får man en feilmelding om at koden er allerede registert. 
            */
        } 
    }
}
